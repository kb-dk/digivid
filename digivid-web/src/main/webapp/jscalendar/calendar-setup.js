...
// $Id: calendar-setup.js,v 1.2 2007/03/13 07:28:35 csr Exp $
...
Calendar.setup = function (params) {
	...
	triggerEl["on" + params.eventName] = function() {
		...
		if (!(cal && params.cache)) {
            ...
            //alert("Created cal object " + cal.toString());
            cal.showsTime = params.showsTime;
			cal.time24 = (params.timeFormat == "24");
			cal.weekNumbers = params.weekNumbers;
			mustCreate = true;
		...
		if (mustCreate)
            //alert("Calling create: " + cal.toString());
            cal.create();
        //alert("Calling refresh: " + cal.toString());
        cal.refresh();
		if (!params.position) {
